...
class GMMA:
    ...
    def simulate(self, num=100, periods="1m" ,end_offset=0):
        ...
        for t in range(61, len(all)):
            ...
            if not short:
                if all[t][3] < sell_price:  # and #all[t-1][18] > 0.0:  #high price is higher than buy_price
                    short = True
                    ...
                    cash=0.
                    amount[t][6] = 555
                    if all[t][4] > buy_price:  # close price is lower than sell_price
                        short = False
                        ...
                        trading_cash = 0.
                        amount[t][5] = 888
                    if not (all[t][2] > buy_price and all[t][4] < buy_price):
                        counter+=1
            elif short:
...
if __name__ == '__main__':
    ...
    gmma.simulate(num=24 * 7 * 1 + 61, periods="1H", end_offset=3600 * 24 * 30 * 2)
